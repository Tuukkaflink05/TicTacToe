...
## CLI tic tac toe with unbeatable minimax algorithm
...
- you have installed atleast java version `` 21+ ``.
- you have a `` windows 10/11 or the latest version of Mac or Linux ``.
- you have read the README.md below.
...
- Play as the better of the two characters: O
...
### 1. Clone the repository
    ...
    git clone https://github.com/Tuukkaflink05/TicTacToe.git

### 2. change into the appropriate directory

### 3. Compile and run the program

    javac TicTacToeApp.java && java TicTacToeApp

### 4. Follow the instruction and be ready to lose!

## Note

- First time playing on a board size of 4x4 might take a while.
